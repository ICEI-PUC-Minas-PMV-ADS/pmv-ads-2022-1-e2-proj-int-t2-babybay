...
namespace app_babybay.Controllers
{
    public class GuardaRoupasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.GuardaRoupas.Include(g => g.Produto);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var guardaRoupa = await _context.GuardaRoupas
                .Include(g => g.Produto)
        ...
        public async Task<IActionResult> Create([Bind("Id,QntdProduto,ProdutoFavorito,ProdutoId")] GuardaRoupa guardaRoupa)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var guardaRoupa = await _context.GuardaRoupas.FindAsync(id);
            if (guardaRoupa == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,QntdProduto,ProdutoFavorito,ProdutoId")] GuardaRoupa guardaRoupa)
        {
        ...
        {
            var guardaRoupa = await _context.GuardaRoupas.FindAsync(id);
            _context.GuardaRoupas.Remove(guardaRoupa);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.GuardaRoupas.Any(e => e.Id == id);
        }
    }
}
