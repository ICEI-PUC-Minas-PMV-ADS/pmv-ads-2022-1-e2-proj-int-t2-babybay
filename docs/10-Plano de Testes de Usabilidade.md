...
Critérios de Êxito | Usuários conseguindo se avaliar e visualizar as avaliações uns dos outros sem nenhuma dificuldade entre os processos:
* E-mails recebidos adequadamente; 
* Envio de avaliação sem travamento; 
* Visualização das avaliações nos locais onde elas precisam ser visualizadas. 
